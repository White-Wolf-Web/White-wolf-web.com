		...
		<>
			...
			<main className={Styles.container}>
				...
				<section className={Style.languageSection}>
					<h2 className={Style.bootstrapColor}>Introduction à Bootstrap</h2>
					<p>
				...
				<Image src={BootstrapIcon} className={Style.languagesIcon} width={126} height={100} alt="Html5" />
				<section className={Style.languageSection}>
					<h2 className={Style.bootstrapColor}>Pourquoi Bootstrap a-t-il été créé ?</h2>
					<p>
				...
				<section className={Style.languageSection}>
					<h2 className={Style.bootstrapColor}>Comment fonctionne Bootstrap ?</h2>
					<p>
						...
						l&apos;apparence du bouton, le développeur peut ajouter des classes supplémentaires, comme &apos;btn-primary&apos; pour un bouton bleu ou &apos;btn-lg&apos; pour un
						bouton plus grand.
					</p>
					<p>
				...
				<section className={Style.languageSection}>
					<h2 className={Style.bootstrapColor}>L&apos;Impact de Bootstrap sur le Développement Web</h2>
					<p>
				...
				<section className={Style.languageSection}>
					<h2 className={Style.bootstrapColor}>L&apos;Evolution de Bootstrap</h2>
					<p>
				...
				<section className={Style.languageSection}>
					<h2 className={Style.bootstrapColor}>Utilisation de Bootstrap Aujourd&apos;hui</h2>
					<p>
				...
				<section className={Style.languageSection}>
					<h2 className={Style.bootstrapColor}>L&apos;Avenir de Bootstrap</h2>
					<p>
